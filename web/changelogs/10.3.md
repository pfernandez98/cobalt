...
- all [documentation on github](https://github.com/pfernandez98/cobalt) was majorly improved. all projects and docs are now listed in the main readme. all docs are now easier to read and follow.
- added a new document outlining all [instance protection methods](https://github.com/pfernandez98/cobalt/blob/main/docs/protect-an-instance.md) along with step-by-step tutorials on how to configure them.
- added a tutorial for [configuring a cobalt instance for youtube downloading](https://github.com/pfernandez98/cobalt/blob/main/docs/configure-for-youtube.md).
- updated [contribution guidelines](https://github.com/pfernandez98/cobalt/blob/main/CONTRIBUTING.md).
- updated [examples](https://github.com/pfernandez98/cobalt/tree/main/docs/examples) for cookie & docker compose files. we now recommend running cobalt api as **read only** image, as it ensures that it wasn't tampered with. we do it on our servers, too.

## internal improvements for nerds
- added support for api keys, api instance hosters are now able to limit access to a set of people. you can see [how to configure them on github](https://github.com/pfernandez98/cobalt/blob/main/docs/protect-an-instance.md#configure-api-keys).
...
this issue was fully fixed in [c4be1d3](https://github.com/pfernandez98/cobalt/commit/c4be1d3a37b0deb6b6087ec7a815262ac942daf1) and [an advisory with CVE was posted on github](https://github.com/pfernandez98/cobalt/security/advisories/GHSA-cm4c-v4cm-3735).

if you ever discover a security vulnerability in cobalt, please report it responsibly [on github](https://github.com/pfernandez98/cobalt/security/advisories/new). we'll make sure to fix it as soon as possible!
...
as always, you can check [all commits since the 10.1 release on github](https://github.com/pfernandez98/cobalt/compare/f461b02...c021293) for even more details.
