...
const contacts = {
  ...
  github: "https://github.com/pfernandez98/cobalt",
...
const docs = {
  instanceHosting:
    "https://github.com/pfernandez98/cobalt/blob/main/docs/run-an-instance.md",
  webLicense: "https://github.com/pfernandez98/cobalt/blob/main/web/LICENSE",
  apiLicense: "https://github.com/pfernandez98/cobalt/blob/main/api/LICENSE",
};
